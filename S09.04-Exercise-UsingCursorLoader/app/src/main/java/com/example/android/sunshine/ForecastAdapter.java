...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        double hiTemp = mCursor.getDouble(MainActivity.INDEX_MAX_TEMP);
        double loTemp = mCursor.getDouble(MainActivity.INDEX_MIN_TEMP);
        String hiAndLowTemps = SunshineWeatherUtils.formatHighLows(mContext, hiTemp, loTemp);

        String weatherSummary = dateString +  " - " + description + " - " + hiAndLowTemps;
