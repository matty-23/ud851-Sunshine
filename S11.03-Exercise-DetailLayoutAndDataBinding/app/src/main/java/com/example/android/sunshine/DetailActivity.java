...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String hiTempA11y = getString(R.string.a11y_high_temp, highString);

        /* Set the text to display the high temperature */
        mDetailBinding.primaryInfo.highTemperature.setText(highString);
        mDetailBinding.primaryInfo.highTemperature.setContentDescription(hiTempA11y);
        ...
        mDetailBinding.extraInfo.humidityLabel.setContentDescription(humidityString);
        mDetailBinding.extraInfo.humidity.setContentDescription(humidityString);
        ...
        mDetailBinding.extraInfo.windLabel.setContentDescription(windString);
        mDetailBinding.extraInfo.wind.setContentDescription(windString);
        ...
        mDetailBinding.extraInfo.pressureLabel.setContentDescription(pressureString);
        mDetailBinding.extraInfo.pressure.setContentDescription(pressureString);
